...
public class ProductDiscountPolicyTests {
    ...
    @Test
    public void calculateDiscountProductDoesNotExistsReturnZero(){
        productDiscountPolicy = new ProductDiscountPolicy(product1, 50);
        ...
        innerHashMap.put(product2,30);
        bagContent.put(category2Name,innerHashMap);
        Assertions.assertTrue(productDiscountPolicy.calculateDiscount(bagContent).equals(0.0));
    }

    @Test
    public void calculateDiscountProductExistsConstraintNotFollowedReturnZero(){
        productDiscountPolicy = new ProductDiscountPolicy(product1, 50,bagConstraint);
    ...
    public void calculateDiscountProductExistsReturnDiscountVal(){
        ...
        bagContent.put(product1Name,innerHashMap);
        Double ExpectedDiscountValue = product1.getPrice()*0.5*product1Amount;

        Assertions.assertTrue(productDiscountPolicy.calculateDiscount(bagContent).equals(ExpectedDiscountValue));
    }
}
